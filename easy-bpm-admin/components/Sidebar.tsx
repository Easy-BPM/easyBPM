...
import { AlertTriangle, Database, LayoutDashboard, Workflow, Search, LogOut, Code2, SquareStack, UserRoundCheck } from 'lucide-react';
  ...
  return (
    <aside className="app-sidebar w-64 bg-slate-950 text-white flex flex-col h-screen sticky top-0 border-r border-slate-800">
      ...
      <div className="px-5 py-5 border-b border-slate-800/80">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 mt-1 leading-none">Admin Console</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-500 px-3 mb-3">Operate</p>
        {menuItems.map((item) => {
