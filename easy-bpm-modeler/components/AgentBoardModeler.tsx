                      ...
                      <div className="flex flex-col gap-3 border-b border-slate-200 bg-white px-4 py-3 lg:flex-row lg:items-center">
                        <div className="flex min-w-0 flex-1 items-center gap-3">
                          ...
                          <div className="grid min-w-0 flex-1 gap-2 md:grid-cols-[0.8fr_1.2fr]">
                            ...
                            <input
                              ...
                              placeholder="What this tool is allowed to do"
                            />
                          </div>
                        </div>
                        <div className="flex shrink-0 items-center gap-2">
                          ...
                          <button
                            ...
                            className="flex h-9 w-9 items-center justify-center rounded-md border border-red-100 bg-white text-red-500 transition-colors hover:bg-red-50"
                            title="Delete tool"
                        ...
                        {tool.type === 'api-call' ? (
                          <>
                            <div className="grid gap-3 lg:grid-cols-[120px_minmax(0,1fr)]">
                              <label className="block space-y-1.5">
                                ...
                                <select
                                  ...
                                  onChange={event => updateTool(tool.id, { method: event.target.value as AgentTool['method'] })}
                              ...
                              <label className="block space-y-1.5">
                                ...
                                <input
                                  value={tool.url || ''}
                                  onChange={event => updateTool(tool.id, { url: event.target.value })}
                                  className="w-full rounded-md border border-slate-300 px-3 py-2 font-mono text-sm text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            ...
                            <div className="grid gap-3 md:grid-cols-3">
                              <label className="block space-y-1.5">
                                ...
                                <select
                                  value={tool.authType || 'none'}
                                  onChange={event => updateTool(tool.id, { authType: event.target.value as AgentToolAuthType })}
                                  className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                >
                              ...
                              {(tool.authType || 'none') !== 'none' && (
                                <label className="block space-y-1.5">
                                  ...
                                  <input
                                    value={tool.authRef || ''}
                                    onChange={event => updateTool(tool.id, { authRef: event.target.value })}
                                    className="w-full rounded-md border border-slate-300 px-3 py-2 font-mono text-sm text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                              ...
                              {(tool.authType || 'none') === 'apikey' && (
                                <label className="block space-y-1.5">
                                  ...
                                  <div className="grid grid-cols-[100px_minmax(0,1fr)] gap-2">
                                    <select
                                      value={tool.authIn || 'header'}
                                      onChange={event => updateTool(tool.id, { authIn: event.target.value as 'header' | 'query' })}
                                      className="rounded-md border border-slate-300 bg-white px-2 py-2 text-sm text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                    >
                                      <option value="header">Header</option>
                                      <option value="query">Query</option>
                                    </select>
                                    <input
                                      value={tool.authKey || 'X-API-Key'}
                                      onChange={event => updateTool(tool.id, { authKey: event.target.value })}
                                      className="min-w-0 rounded-md border border-slate-300 px-3 py-2 font-mono text-sm text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            ...
                            <div className="grid gap-3 lg:grid-cols-2">
                              <label className="block space-y-1.5">
                                ...
                                <textarea
                                  value={tool.headers || ''}
                                  onChange={event => updateTool(tool.id, { headers: event.target.value })}
                                  className="h-24 w-full resize-none rounded-md border border-slate-300 px-3 py-2 font-mono text-xs text-slate-800 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                              ...
                              <label className="block space-y-1.5">
                                ...
                                <textarea
                                  ...
                                  onChange={event => updateTool(tool.id, { bodyTemplate: event.target.value })}
                                  className="h-24 w-full resize-none rounded-md border border-slate-300 px-3 py-2 font-mono text-xs text-slate-800 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                  placeholder='{ "caseId": "{{caseId}}" }'
                                />
                              </label>
                            </div>
                          </>
                          ...
                          <div className="grid gap-3 md:grid-cols-3">
                            <label className="block space-y-1.5">
                              ...
                              <input
                                value={tool.jarId || ''}
                                onChange={event => updateTool(tool.id, { jarId: event.target.value })}
                                className="w-full rounded-md border border-slate-300 px-3 py-2 font-mono text-sm text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                placeholder="42 or policy-service"
                              />
                            </label>
                            <label className="block space-y-1.5">
                              ...
                              <input
                                ...
                                onChange={event => updateTool(tool.id, { className: event.target.value })}
                                className="w-full rounded-md border border-slate-300 px-3 py-2 font-mono text-sm text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                placeholder="com.example.PolicyService"
                              />
                            </label>
                            <label className="block space-y-1.5">
                              <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Method</span>
                              <input
                                ...
                                onChange={event => updateTool(tool.id, { methodName: event.target.value })}
                                className="w-full rounded-md border border-slate-300 px-3 py-2 font-mono text-sm text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                        ...
                        <div className="grid gap-3 lg:grid-cols-2">
                          <label className="block space-y-1.5">
                            ...
                            <textarea
                              ...
                              onChange={event => updateTool(tool.id, { inputSchema: event.target.value })}
                              className="h-32 w-full resize-none rounded-md border border-slate-300 px-3 py-2 font-mono text-xs text-slate-800 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            />
                          </label>
                          <label className="block space-y-1.5">
                            <span className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest text-slate-500">
                            ...
                            <textarea
                              ...
                              onChange={event => updateTool(tool.id, { outputSchema: event.target.value })}
                              className="h-32 w-full resize-none rounded-md border border-slate-300 px-3 py-2 font-mono text-xs text-slate-800 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            />
                          </label>
                        </div>
